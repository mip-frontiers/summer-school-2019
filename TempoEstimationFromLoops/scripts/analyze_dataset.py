...
@click.option('--algorithms', default='rhythm_essentia_basic,rhythm_percival14,rhythm_madmom,durations',
              help='Algorithm names separated by commas (default rhythm_essentia_basic,rhythm_percival14,rhythm_madmom,durations).')
